...
export const homePage = {
  ...
  intro: [
    "수상과 프로젝트가 쌓이는 팀에서,\n브랜드와 웹과 자료를 함께 포트폴리오로 만들어갈 초기 디자이너를 찾습니다.",
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "디자이너가 합류하면 흩어진 실적을 IR 덱, 영업자료, 프로젝트 페이지, 제품 소개 페이지, 콘텐츠 템플릿으로 바꿔 바로 자기 포트폴리오에 남길 수 있습니다.",
      ],
      columns: [
        {
          title: "공개 성과",
    ...
    },
    {
      ...
      columns: [
        ...
        {
          title: "자료와 콘텐츠",
          body: "IR 덱, 제안서, 세일즈 덱, 프로그램 지원 자료, 프로젝트 회고 콘텐츠를 실제 목적에 맞게 다듬습니다.",
        },
      ],
    },
  ],
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "다음 단계는 이 실적을 더 설득력 있는 브랜드, 웹, 자료, 콘텐츠로 정리하는 것입니다. 그래서 이번 채용도 단순 보조가 아니라 회사의 포트폴리오를 함께 만드는 자리입니다.",
      ],
    },
  ],
  linkCards: [
...
export const culturePage = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        "전문 도메인의 복잡함을 고객과 지원자가 이해할 수 있는 문장, 다이어그램, 웹 페이지, 자료로 바꾸는 능력을 중요하게 봅니다.",
      ],
    },
    {
      eyebrow: "06",
